...
"""
    ABOUT_TEXT = """
 **🤖 Bot :** Url Uploader\n
 **👲 Developer :** [Tellybots](https://telegram.me/KenzoMovie)\n
 **👥 Channel :** [Tellybots](https://telegram.me/KenzoMovie)\n

"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('🤖 Channel', url='https://telegram.me/KenzoMovie'),
        InlineKeyboardButton('💬 Support', url='https://telegram.me/KenzoMovie')
        ],[
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = " JOIN : https://t.me/KenzoMovie\nFor the List of Telegram Bots"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\n\nThanks For Using Me\n\nUploaded in {} seconds."
    NOT_AUTH_USER_TEXT = "Please /upgrade your subscription."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/KenzoMovie'>@KenzoMovie</a>"
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "Join : @KenzoMovie \n For the list of Telegram bots. "
    EXTRACT_ZIP_INTRO_ONE = "Send a compressed file first, Then reply /unzip command to the file."
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. ⚠️ This might take some time. Please be patient. "
    UNZIP_SUPPORTED_EXTENSIONS = ("zip", "rar")
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/KenzoMovie'>@KenzoMovie</a>"
...
/upgrade or Try 1800 seconds later."""
    SLOW_URL_DECED = "Gosh that seems to be a very slow URL. Since you were screwing my home, I am in no mood to download this file. Meanwhile, why don't you try this:==> get me a fast URL so that I can upload to Telegram, without me slowing down for other users."
